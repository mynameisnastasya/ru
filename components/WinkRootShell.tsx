...
function NavIcon({ type }: { type: "home" | "search" | "heart" | "user" | "bag" | "menu" | "close" }) {
  ...
  return <>
    <header className={`wink26-header ${scrolled ? "scrolled" : ""}`} aria-label="Навигация WINK">
      ...
      <div className="wink26-tools">
        ...
        <Link href="/checkout" aria-label="Корзина"><NavIcon type="bag"/></Link>
