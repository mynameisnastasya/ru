...
function Icon({ type }: { type: "home" | "search" | "heart" | "user" | "bag" | "menu" }) {
  ...
  return <div className="wps26">
    <header className="wps26-header">
      ...
      <div className="wps26-tools">
        ...
        <Link href="/account" aria-label="Профиль"><Icon type="user"/></Link>
